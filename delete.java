...
class delete implements ItemListener,ActionListener
{
...
String path,id;
	...
	public delete(JFrame f1,JFrame f2)
	{	
		fx = f1;
		fc = f2;
		...
		b2 = new JButton("Delete",new ImageIcon("images/delete4.png"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b2)
		{
			try
			{
				String id = txt[0].getText().substring(4);
				Connection con = dao.createconnection();
				PreparedStatement ps = con.prepareStatement("delete from emp_record where uid=?");
				ps.setString(1,txt[0].getText());
				int z = ps.executeUpdate();
				if(z>0)
				{
					JOptionPane.showMessageDialog(fr,"Record Deleted Successfully.....");
					txt[0].setText("");
					txt[1].setText("");
					txt[2].setText("");
					txt[3].setText("");
					...
					File fe = new File("photo/"+id+".jpg");
					fe.delete();
				}
				else
				{
					JOptionPane.showMessageDialog(fr,"Record Not Deleted.....");
	        		}
				con.close();
			}
			catch(Exception e)
